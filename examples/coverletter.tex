...
\address{\faHome \acvHeaderIconSep Peniche, Portugal %{\enskip\cdotp\enskip} \faFlag \acvHeaderIconSep Nationality: Portuguese\\
...
\recipient
  {Miniclip Recruitment}
  {Miniclip Portugal\\Av. Prof. Dr. Cavaco Silva 11, 2740-120 Porto Salvo}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Software Developer (Server) - Games Industry} 
...
\begin{itemize}
	...
	%\item Expertise in several multidisciplinary technologies (Android, Unity, Java Swing).
