  ...
  \cventry
    ...
    {} % Date(s)
    {
      ...
      \begin{cvitems} % Description(s) 
        ...
        %\textcolor{rainbowcolor-green}{Slack\ref{5}{$^{[5]}$}}, 
        ...
        %\textcolor{rainbowcolor-green}{Blender\ref{2}{$^{[2]}$}}, 
        %\textcolor{rainbowcolor-green}{JMonkeyEngine\ref{2}{$^{[2]}$}}, 
        ...
        %\textcolor{rainbowcolor-green}{Texmaker \& JabRef\ref{4}{$^{[4]}$}}, 
        \textcolor{rainbowcolor-green}{IIS 6-8\ref{5}{$^{[5]}$}}.%,
        %\textcolor{rainbowcolor-green}{VNC\ref{5}{$^{[5]}$}},
        %\textcolor{rainbowcolor-green}{mRemote\ref{5}{$^{[5]}$}},
        %\textcolor{rainbowcolor-green}{Cisco AnyConnect\ref{5}{$^{[5]}$}}, %Cisco VPN client, 
		%\textcolor{rainbowcolor-green}{FortiClient\ref{5}{$^{[5]}$}}.
		}
      \end{cvitems}
    }  
  %\vspace{-0.4cm}  
