  ...
  \cventry
    ...
    {Jan. 2019 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities      
		\item {\textbf{Context:} account transfer among banks, adaptive software development and integration with Model-Based architecture for banking software. 
}
		\item {\textbf{Functions:} inspecting PL-SQL queries, the sequence of queries, and then fine tuning those queries prior to sending data. Day to day support activities, investigate and address issues regarding quality of sent data with the business area. Adaptive, perfective and corrective software maintenance for banking 	solutions.}		
