  ...
  \cventry
    ...
    {Jan. 2013 - June 2017} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        ...
        \item {\textbf{Functions:} Gathering/analysis of state-of-the-art regarding (i)modular game engine architectures, (ii)video game technologies teaching methodologies, (iii)influence maps and path finding algorithms. %(iv)scene management in virtual environments. 
